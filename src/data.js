...
const topics = [
  ...
  "Containers and HPC",
  "Workflow Orchestration in HPC",
  "Machine Learning and HPC",
  "Numerical Simulations in HPC",
  "HPC in Healthcare and Life Sciences",
  "High-Performance Data Analytics",
  "Real-time HPC Applications",
  "Edge Computing in HPC",
  "HPC Security and Privacy",
  "Exascale Computing",
  "Middleware for HPC",
  ...
  "Quantitative Analysis of HPC Systems",
  "Data Movement in HPC",
  "GPU Programming Languages",
  "Task Scheduling in HPC",
  "Multi-core Processors in HPC",
  ...
  "Linux Security (Firewall, SELinux, AppArmor)",
  "Systemd and Service Management",
  "Kernel Modules",
  "Networking in Linux",
  "File Permissions and Ownership",
  "Linux Shell Environments (bash, zsh)",
  "GNU Tools (gcc, gdb, make)",
  "Linux Containers (Docker, Podman)",
  "System Performance Monitoring (top, htop, iostat)",
  "Linux File Systems (ext4, Btrfs, XFS)",
  "Linux Desktop Environments (GNOME, KDE, Xfce)",
  "Virtualization (KVM, VirtualBox)",
  "Linux Boot Process",
  "Linux Text Editors (vim, emacs)",
  "Linux Command-Line Interface (CLI)",
  "Linux File Compression and Archiving (tar, gzip, zip)",
  "Linux System Logs and Log Rotation",
  ...
  "Collaboration tools for system administrators",
  ...
  "Canadian wildlife conservation efforts",
  "Toronto skyline photography",
  "Indigenous peoples of Canada",
  "Banff National Park hiking trails",
  "Quebecois cuisine recipes",
  "Vancouver film festivals 2023",
  "Canadian Rockies road trip itinerary",
  "Polar bear migration patterns in the Arctic",
  "Canadian space exploration initiatives",
  "Hockey culture in Canada",
  "Northern Lights viewing spots in Yukon",
  "Poutine variations across provinces",
  "Canadian authors and literature",
  "Ottawa Parliament Hill events",
  "Whistler Blackcomb ski conditions",
  "Nova Scotia lighthouse tours",
  "Canadian craft beer breweries",
  "Vancouver Island surfing spots",
  "Montreal jazz festivals schedule",
  ...
  "Linux Mint desktop customization",
  "Fedora Workstation features",
  "Linux shell commands cheat sheet",
  "OpenSUSE software repositories",
  ...
  "Linux text editors (e.g., Vim, Emacs)",
  "Linux device drivers development",
  "Linux kernel modules",
  "Linux disk partitioning",
  "Linux software RAID",
  "Linux desktop security best practices",
  ...
  "Kubernetes etcd datastore",
  "Factorio automation tips",
  "Efficient Factorio factory designs",
  "Factorio train signaling guide",
  "Factorio circuit network tutorial",
  "Factorio main bus strategy",
  "Factorio logistic system setup",
  "Factorio oil processing blueprint",
  "Factorio nuclear power guide",
  "Factorio mod recommendations",
  "Factorio early game walkthrough",
  "Factorio late game challenges",
  "Factorio science pack ratios",
  "Factorio multiplayer server settings",
  "Factorio blueprint string exchange",
  "Factorio combat tactics",
  "Factorio railworld settings",
  "Factorio mining outpost design",
  "Factorio main bus vs. spaghetti",
  "Factorio fluid handling tutorial",
  "Factorio belt balancing techniques",
  "Banff National Park",
  "Calgary Stampede",
  ...
  "Behavioral finance in stock trading"
];
